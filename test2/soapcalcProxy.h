...
{ public:
	...
	/// Web service operation 'sqrt' (returns error code or SOAP_OK)
	virtual	int sqrt(double a, double *result) { return this->sqrt(NULL, NULL, a, result); }
	virtual	int sqrt(const char *endpoint, const char *soap_action, double a, double *result);
};
#endif
